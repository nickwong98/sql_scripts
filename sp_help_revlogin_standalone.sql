-- Adapted from https://docs.microsoft.com/en-us/troubleshoot/sql/security/transfer-logins-passwords-between-instances
declare @binvalue varbinary(256), @charvalue varchar (514),@i int,@length int,@hexstring char(16), @tempint int,@firstint int, @secondint int
      
DECLARE @login_name SYSNAME = ... /* login to script */
